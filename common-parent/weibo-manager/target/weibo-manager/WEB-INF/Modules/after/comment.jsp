    ...
    <div class="row">
        ...
        <div class="col col-md-8">
            ...
            <div class="media_weibo media">
                <div class="media-left">
                    <br>
                    <a href="/after/personalPage.do?user_id=${description.user_id}">
                        <img src="/pic/${description.headimage }" width="40" height="40">
                    </a>
                </div>
                <div class="media-body">
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <button class="btn btn-warning pull-right">评论</button>
                    </div>
                </div>
            </div>
            <ul class="list-group">
                    ...
                    <li class="list-group-item">
                        <div class="comment media">
                            <div class="headimg media-left">
                                <br>
                                <a href="/after/personalPage.do?user_id=${comment.fromuser_id}" target="_blank">
                                    ...
                                    <c:forEach items="${comment.replyUserList }" var="reply">
                                        <li class="list-group-item reply">
                                            <div class="media">
                                                <div class="headimg media-left">
                                                    <br>
                                                    <a href="/after/personalPage.do?user_id=${reply.fromuser_id}" target="_blank">
                                                ...
                                                <div class="content media-body">
                                                    ...
                                                    <c:choose>
                                                        <c:when test="${reply.reply_type=='comment' }">
                                                            <h4><a class="text-info" href="/after/personalPage.do?user_id=${reply.fromuser_id}" target="_blank">${reply.fromnickname }：</a>${reply.content }</h4>
                                                        </c:when>
                                                        <c:otherwise>
                                                            <h4><a class="text-info" href="/after/personalPage.do?user_id=${reply.fromuser_id}" target="_blank">${reply.fromnickname }</a> 回复 <a class="text-info" href="/after/personalPage.do?user_id=${reply.touser_id}" target="_blank"> ${reply.tonickname }：</a>${reply.content }</h4>
                                                        </c:otherwise>
                                                    </c:choose>
                                                    <p class="small">
